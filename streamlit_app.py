...
user_input = st.chat_input("Describe your query here...")
...
if user_input:
    ...
    assistant_prompt = f"User has reported the following query: {user_input}. Provide an appropriate response about Physics to that query."
