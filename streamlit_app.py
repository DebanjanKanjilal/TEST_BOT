...
user_input = st.chat_input("Ask about Shah Rukh Khan here...")
...
if user_input:
    ...
    assistant_prompt = f"User has reported the following query: {user_input}. Provide an appropriate response about Shah Rukh Khan to that query."
